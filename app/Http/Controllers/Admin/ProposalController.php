...
class ProposalController extends Controller
{
    ...
    {
        $proposals = Proposal::with('job','teacher')->where('teacher_id', auth()->id())->paginate(5);
    ...
    {
        $proposal = Proposal::create($request->validated() + ['teacher_id' => auth()->id()]);
    ...
    {
        $proposal->update($request->validated() + ['teacher_id' => auth()->id()]);
